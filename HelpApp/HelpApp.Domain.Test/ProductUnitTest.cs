...
namespace HelpApp.Domain.Test
{
    public class ProductUnitTest
    {
        ...
        public void CreateProduct_WithIdAndValidParameters_ResultObjectValidState()
        {
        ...
        [Fact(DisplayName = "Create Product With Name, Descreiption, Price, Stock and Image")]
        public void CreateProduct_WithValidParameters_ResultObjectValidState()
        {
            Action action = () => new Product("Product Name", "Product Description", 9.99m, 99, "https://img/product.jpg");
